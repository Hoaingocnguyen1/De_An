...
class MultimodalEmbedder:
    ...
    def embed_image(self, image: Image.Image) -> List[float]:
        ...
        try:
            ...
            result = voyageai.multimodal_embed(
                inputs=[[base64_image]],
                model=self.model_name,
                input_type="document"
            )
...
class ContentEmbedder:
    ...
    def embed_figure(
        ...
        # Use multimodal embedding with both image and text
    ...
    def embed_table(
        ...
        Can use visual representation if available
        """
        try:
        ...
        # Use multimodal embedding if table image is available
        if table_image:
            vector = self.multimodal_embedder.embed_table_with_image(
